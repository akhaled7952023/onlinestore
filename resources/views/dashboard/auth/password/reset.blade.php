              ...
              <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                <div class="card-header border-0 pb-0">
                  ...
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>{{__('passwords.new_password')}}</span>
                  </h6>
                </div>
                    ...
                    <form action="{{ route('dashboard.password.reset.post') }}" method="POST" class="form-horizontal" action="login-simple.html" novalidate>
                      ...
                      <fieldset  class="form-group position-relative has-icon-left">
                        <input
                             ...
                             id="user-email"
                             placeholder="{{__('passwords.confirm_new_password')}}"
                             >
                        <div class="form-control-position">
                          <i class="ft-mail"></i>
                        </div>
                      ...
                      <button type="submit" class="btn btn-outline-info btn-lg btn-block"><i class="ft-unlock"></i> {{__('passwords.reset_password')}}</button>
                    </form>
                  </div>
                </div>
